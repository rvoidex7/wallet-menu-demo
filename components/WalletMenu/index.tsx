          ...
          >
              <TouchableOpacity activeOpacity={0.9} onPress={handleHeaderTap}>
                  <View style={styles.sheetHeader}>
                      <View style={styles.walletBarLines}>
                          <View style={styles.walletBarLine} />
                          <View style={styles.walletBarLine} />
                      </View>
                      <Text style={styles.walletBarText}>Wallet</Text>
                  </View>
              </TouchableOpacity>
          </PanGestureHandler>
              ...
              <View style={styles.sheetContentContainer}>
                  ...
                  <View style={styles.qrCodeSection}>
                      ...
                      <View style={styles.qrCodeContainer}>
                          <Ionicons name="qr-code" size={100} color="#634832" />
                      </View>
                  </View>
              </View>
          </PanGestureHandler>
...
const styles = StyleSheet.create({
  ...
  stampFilled: { backgroundColor: '#fcd34d' },
